...
def setup_database():
    ...
    print(
        f"🗄️  Database type: {'PostgreSQL' if 'postgresql' in os.getenv('DATABASE_URL', '') else 'SQLite'}"
    )
    ...
    try:
        ...
        print(
            f"💡 Make sure your database is running and environment variables are set correctly"
        )
        sys.exit(1)
