...
class User(Base):
    ...
    )  # Set to True by default since we're skipping profile creation
    ...
    connections_as_elder = relationship(
        "Connection", foreign_keys="Connection.elder_id", back_populates="elder"
    )
    connections_as_seeker = relationship(
        "Connection", foreign_keys="Connection.seeker_id", back_populates="seeker"
    )
...
class Connection(Base):
    ...
    # Relationships
    elder = relationship(
        "User", foreign_keys=[elder_id], back_populates="connections_as_elder"
    )
    seeker = relationship(
        "User", foreign_keys=[seeker_id], back_populates="connections_as_seeker"
    )
