...
def main():
    ...
    <div class="main-header">
        ...
        <p> Connecting Generations Through Stories In today's fast-paced digital world, the wisdom and experiences of our elders are at risk of being lost. StoryShare provides a platform to preserve these invaluable stories and connect generations through shared experiences. Our elders carry decades of wisdom, historical perspectives, and life lessons that can guide younger generations through their own journeys. This project aims to create meaningful connections between generations, allowing elders to share their legacy while helping younger people gain insights they can't find in textbooks or online searches. "When an elder dies, a library burns to the ground." — African proverb . By sharing and documenting these stories, we not only honor our elders but also create a bridge of understanding between differences<p>
    </div>
    """,
        unsafe_allow_html=True,
    )
